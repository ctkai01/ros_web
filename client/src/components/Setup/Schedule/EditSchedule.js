...
const EditSchedule = () => {
  ...
  const [isRunAsSoonAsPossible, setIsRunAsSoonAsPossible] = useState(false);
  ...
  const handleIsRunAsSoonAsPossibleChange = () => {
    // Toggle the boolean value
    setIsRunAsSoonAsPossible(!isRunAsSoonAsPossible);
  };
      ...
      <form className="form-container" onSubmit={handleSubmit}>
        ...
        >
          <label>
            <input
              type="checkbox"
              checked={isRunAsSoonAsPossible}
              onChange={handleIsRunAsSoonAsPossibleChange}
            />
