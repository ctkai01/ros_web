...
const WhileSettings = ({ action, panelId, onClose, onSave }) => {
  const fieldConfigs = createActionFieldConfigs.while(); // Sử dụng config riêng cho WhileAction
  ...
  const renderFields = () => {
    ...
    const compareValue = formData.compare?.variable || '0';
